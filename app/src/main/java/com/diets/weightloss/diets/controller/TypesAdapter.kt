package com.diets.weightloss.diets.controller
...
import com.diets.weightloss.diets.IClick

class TypesAdapter(val listSchemas: List<com.diets.weightloss.POJOS.schema.Schema>,
