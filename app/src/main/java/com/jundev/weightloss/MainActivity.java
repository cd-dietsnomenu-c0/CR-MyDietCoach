...
import com.jundev.weightloss.diets.FragmentSections;
import com.jundev.weightloss.settings.FragmentSettings;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseMessaging.getInstance().subscribeToTopic("feed").addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
