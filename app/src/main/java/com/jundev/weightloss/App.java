...
import com.jundev.weightloss.common.db.DietDatabase;
...
public class App extends MultiDexApplication {
    ...
    public void onCreate() {
        ...
        Amplitude.getInstance().initialize(this, AnalyticsVersion.AMPLITUDE_CATAPULT).
    ...
    public void createNotificationChannel(@NonNull Context context) {
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            String channelId = "com.jundev.weightloss";
            String channelName = "com.jundev.weightloss";
